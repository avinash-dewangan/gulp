tinymce.PluginManager.add("link", function(a) {
    ...
    function d(b) {
        ...
        if(checkIfLinkFunctionalityAvailable(a.bodyElement.classList)){
        	$("#editable-non-editable-msg").html("LINK FUNCTION IS NOT AVAILABLE").stop().fadeIn(200).delay(2000).fadeOut(200);
        	return false;
        }
        ...
        l = a.windowManager.open({
            ...
            onSubmit: function(b) {
                ...
                function d() {
                    var b = {
                        href: e,
                        target: u.target ? u.target : "_blank" ,
                        rel: u.rel ? u.rel : null ,
                        "class": u["class"] ? u["class"] : null ,
                        title: u.title ? u.title : null
                    };
                    j ? (a.focus(),
                    m && u.text != k && ("innerText"in j ? j.innerText = u.text : j.textContent = u.text),
                    w.setAttribs(j, b),
                    v.select(j),
                    a.undoManager.add()) : m ? a.insertContent(w.createHTML("a", b, w.encode(u.text))) : a.execCommand("mceInsertLink", !1, b)
                }
                var e;
                ...
                (e = u.href) ? e.indexOf("@") > 0 && -1 == e.indexOf("//") && -1 == e.indexOf("mailto:") ? (
                    true && (e = "mailto:" + e),
                    d()
                ) : a.settings.link_assume_external_targets && !/^\w+:/i.test(e) || !a.settings.link_assume_external_targets && /^\s*www[\.|\d\.]/i.test(e) ? (
                    true && (e = "http://" + e),
